...
const QuickSetupWizard = () => {
  ...
  const [publishConfirmCallback, setPublishConfirmCallback] = useState(null);
  ...
  const handlePublish = async () => {
    ...
    if (fieldsWithoutValues.length > 0) {
      ...
      setPublishConfirmMessage(warningMessage);
      setPublishConfirmCallback(() => () => {
  ...
  return (
    <div className="dashboard-layout">
      ...
      <ConfirmModal
        ...
        onConfirm={() => {
          if (publishConfirmCallback) {
            publishConfirmCallback();
          }
        }}
        onCancel={() => {
          setShowPublishConfirm(false);
          setPublishConfirmCallback(null);
        }}
